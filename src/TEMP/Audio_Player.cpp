...
//---------------------------------------------------------------------------------------------------------------------
Audio_Player::Audio_Player(bool internalDAC /* = false */, uint8_t channelEnabled /* = I2S_DAC_CHANNEL_BOTH_EN */, uint8_t i2sPort)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setBufsize(int rambuf_sz, int psrambuf_sz)
{
    if (InBuff.isInitialized())
    {
        log_e("Audio_Player::setBufsize must not be called after audio is initialized");
        return;
    }
    InBuff.setBufsize(rambuf_sz, psrambuf_sz);
};

void Audio_Player::initInBuff()
{
    if (!InBuff.isInitialized())
    {
...
//---------------------------------------------------------------------------------------------------------------------
esp_err_t Audio_Player::I2Sstart(uint8_t i2s_num)
{
...
esp_err_t Audio_Player::I2Sstop(uint8_t i2s_num)
{
    return i2s_stop((i2s_port_t)i2s_num);
}
//---------------------------------------------------------------------------------------------------------------------
esp_err_t Audio_Player::i2s_mclk_pin_select(const uint8_t pin)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setConnectionTimeout(uint16_t timeout_ms, uint16_t timeout_ms_ssl)
{
    if (timeout_ms)
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::connecttohost(const char *host, const char *user, const char *pwd)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::httpPrint(const char *host)
{
    // user and pwd for authentification only, can be empty
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setFileLoop(bool input)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::UTF8toASCII(char *str)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::connecttoSD(const char *path, int32_t resumeFilePos)
{
    return connecttoFS(SD, path, resumeFilePos);
}
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::connecttoFS(fs::FS &fs, const char *path, int32_t resumeFilePos)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::connecttospeech(const char *speech, const char *lang)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::urlencode(char *buff, uint16_t buffLen, bool spacesOnly)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::showID3Tag(const char *tag, const char *value)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::unicode2utf8(char *buff, uint32_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::latinToUTF8(char *buff, size_t bufflen)
{
...
//---------------------------------------------------------------------------------------------------------------------
size_t Audio_Player::readAudioHeader(uint32_t bytes)
{
...
//---------------------------------------------------------------------------------------------------------------------
int Audio_Player::read_WAV_Header(uint8_t *data, size_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
int Audio_Player::read_FLAC_Header(uint8_t *data, size_t len)
{
    static size_t headerSize;
...
//---------------------------------------------------------------------------------------------------------------------
int Audio_Player::read_ID3_Header(uint8_t *data, size_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
int Audio_Player::read_M4A_Header(uint8_t *data, size_t len)
{
    /*
           ftyp
...
//---------------------------------------------------------------------------------------------------------------------
size_t Audio_Player::process_m3u8_ID3_Header(uint8_t *packet)
{
    uint8_t ID3version;
    size_t id3Size;
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::stopSong()
{
    uint32_t pos = 0;
    if (m_f_running)
    {
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::readPlayListData()
{
...
//----------------------------------------------------------------------------------------------------------------------
const char *Audio_Player::parsePlaylist_M3U()
{
...
//----------------------------------------------------------------------------------------------------------------------
const char *Audio_Player::parsePlaylist_PLS()
{
    uint8_t lines = m_playlistContent.size();
    int pos = 0;
    char *host = nullptr;
...
//----------------------------------------------------------------------------------------------------------------------
const char *Audio_Player::parsePlaylist_ASX()
...
//----------------------------------------------------------------------------------------------------------------------
const char *Audio_Player::parsePlaylist_M3U8()
{
    uint8_t lines = m_playlistContent.size();
    bool f_begin = false;
    uint8_t occurence = 0;
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::STfromEXTINF(char *str)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::processLocalFile()
{
...
//----------------------------------------------------------------------------------------------------------------------
void Audio_Player::processWebStream()
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::processWebFile()
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::processWebStreamTS()
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::processWebStreamHLS()
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::playAudioData()
{
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::parseHttpResponseHeader()
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::initializeDecoder()
{
    uint32_t gfH = 0;
    uint32_t hWM = 0;
    switch (m_codec)
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::parseContentType(char *ct)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::showstreamtitle(const char *ml)
{
    // example for ml:
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::showCodecParams()
{
...
//---------------------------------------------------------------------------------------------------------------------
int Audio_Player::findNextSync(uint8_t *data, size_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setDecoderItems()
{
    if (m_codec == CODEC_MP3)
    {
...
//---------------------------------------------------------------------------------------------------------------------
int Audio_Player::sendBytes(uint8_t *data, size_t len)
{
    int bytesLeft;
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::compute_audioCurrentTime(int bd)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::printDecodeError(int r)
{
    const char *e;
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setPinout(uint8_t BCLK, uint8_t LRC, uint8_t DOUT, int8_t DIN, int8_t MCK)
{
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::getFileSize()
{
    if (!audiofile)
        return 0;
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::getFilePos()
{
    if (!audiofile)
        return 0;
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::getAudioDataStartPos()
{
    if (!audiofile)
        return 0;
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::getAudioFileDuration()
{
    if (getDatamode() == AUDIO_LOCALFILE)
    {
        if (!audiofile)
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::getAudioCurrentTime()
{ // return current time in seconds
    return (uint32_t)m_audioCurrentTime;
}
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setAudioPlayPosition(uint16_t sec)
{
    if (m_codec == CODEC_OPUS)
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setVolumeSteps(uint8_t steps)
{
    m_vol_steps = steps;
    if (steps < 1)
...
//---------------------------------------------------------------------------------------------------------------------
uint8_t Audio_Player::maxVolume()
{
    return m_vol_steps;
};
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::getTotalPlayingTime()
{
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setTimeOffset(int sec)
{
    if (m_codec == CODEC_OPUS)
        return false; // not impl. yet
    if (m_codec == CODEC_VORBIS)
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setFilePos(uint32_t pos)
{
    if (m_codec == CODEC_OPUS)
        return false; // not impl. yet
    if (m_codec == CODEC_VORBIS)
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::audioFileSeek(const float speed)
{
    // 0.5 is half speed
    // 1.0 is normal speed
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setSampleRate(uint32_t sampRate)
{
    if (!sampRate)
...
uint32_t Audio_Player::getSampleRate()
{
    return m_sampleRate;
}
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setBitsPerSample(int bits)
{
    if ((bits != 16) && (bits != 8))
        return false;
...
uint8_t Audio_Player::getBitsPerSample()
{
    return m_bitsPerSample;
}
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setChannels(int ch)
{
    if ((ch < 1) || (ch > 2))
        return false;
    m_channels = ch;
...
uint8_t Audio_Player::getChannels()
{
    if (m_channels == 0)
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::setBitrate(int br)
{
    m_bitRate = br;
    if (br)
        return true;
...
uint32_t Audio_Player::getBitRate(bool avg)
{
    if (avg)
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setI2SCommFMT_LSB(bool commFMT)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::computeVUlevel(int16_t sample[2])
{
...
//---------------------------------------------------------------------------------------------------------------------
uint16_t Audio_Player::getVUlevel()
{
    // avg 0 ... 127
    if (!m_f_running)
        return 0;
...
//---------------------------------------------------------------------------------------------------------------------
bool Audio_Player::playSample(int16_t sample[2])
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setTone(int8_t gainLowPass, int8_t gainBandPass, int8_t gainHighPass)
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::forceMono(bool m)
{                      // #100 mono option
    m_f_forceMono = m; // false stereo, true mono
}
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setBalance(int8_t bal)
{ // bal -16...16
    if (bal < -16)
        bal = -16;
    if (bal > 16)
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::setVolume(uint8_t vol, uint8_t curve)
...
//---------------------------------------------------------------------------------------------------------------------
uint8_t Audio_Player::getVolume()
{
    return m_vol;
}
//---------------------------------------------------------------------------------------------------------------------
uint8_t Audio_Player::getI2sPort()
{
    return m_i2s_num;
}
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::computeLimit()
...
int32_t Audio_Player::Gain(int16_t s[2])
{
    int32_t v[2];
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::inBufferFilled()
{
    // current audio input buffer fillsize in bytes
    return InBuff.bufferFilled();
}
//---------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::inBufferFree()
{
...
//---------------------------------------------------------------------------------------------------------------------
void Audio_Player::IIR_calculateCoefficients(int8_t G0, int8_t G1, int8_t G2)
...
//---------------------------------------------------------------------------------------------------------------------
int16_t *Audio_Player::IIR_filterChain0(int16_t iir_in[2], bool clear)
{ // Infinite Impulse Response (IIR) filters
...
//---------------------------------------------------------------------------------------------------------------------
int16_t *Audio_Player::IIR_filterChain1(int16_t iir_in[2], bool clear)
{ // Infinite Impulse Response (IIR) filters
...
//---------------------------------------------------------------------------------------------------------------------
int16_t *Audio_Player::IIR_filterChain2(int16_t iir_in[2], bool clear)
{ // Infinite Impulse Response (IIR) filters
...
//----------------------------------------------------------------------------------------------------------------------
bool Audio_Player::ts_parsePacket(uint8_t *packet, uint8_t *packetStart, uint8_t *packetLength)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint16_t Audio_Player::readMetadata(uint16_t maxBytes, bool first)
{
...
//----------------------------------------------------------------------------------------------------------------------
size_t Audio_Player::chunkedDataTransfer(uint8_t *bytes)
{
...
//----------------------------------------------------------------------------------------------------------------------
bool Audio_Player::readID3V1Tag()
{
...
//----------------------------------------------------------------------------------------------------------------------
boolean Audio_Player::streamDetection(uint32_t bytesAvail)
{
...
//----------------------------------------------------------------------------------------------------------------------
void Audio_Player::seek_m4a_ilst()
{
...
//----------------------------------------------------------------------------------------------------------------------
void Audio_Player::seek_m4a_stsz()
{
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::m4a_correctResumeFilePos(uint32_t resumeFilePos)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::flac_correctResumeFilePos(uint32_t resumeFilePos)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t Audio_Player::mp3_correctResumeFilePos(uint32_t resumeFilePos)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint8_t Audio_Player::determineOggCodec(uint8_t *data, uint16_t len)
{
